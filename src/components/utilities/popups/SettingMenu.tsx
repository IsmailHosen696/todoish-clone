...
export default function SettingMenu() {
    ...
    return (
        <div ref={settingRef} className={`w-auto absolute ${isSettingMenuOpen ? 'top-14' : "top-0"} dark:text-gray-100 bg-gray-50 rounded transition-all duration-150 right-12 dark:bg-viewboxDark border dark:border-gray-700 border-gray-200 z-50`}>
