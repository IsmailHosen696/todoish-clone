            ...
            <div className="container mx-auto justify-center items-center flex">
                <div className="flex px-2 py-2 xl:w-4/12 lg:w-6/12 md:w-7/12 sm:w-8/12 w-full rounded border border-gray-200 flex-col mt-10">
                    <div className="flex flex-col w-full">
                        ...
                        <button onClick={handleGoogleSignin} className="items-center flex rounded mt-5 mb-3 outline-none  border border-gray-200 hover:border-gray-300 justify-center mx-2 h-10">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col px-3 mt-2">
                            ...
                            <div className="flex flex-col relative mt-3">
                                ...
                                <input value={password} onChange={(e: ChangeEvent<HTMLInputElement>) => setPassword(e.target.value)} placeholder="add password here" autoComplete="off" type={isEyeOpen ? "text" : "password"} id="password" className="placeholder-gray-400  border border-gray-200 focus:ring focus:ring-blue-400 outline-none rounded h-10 px-2" />
